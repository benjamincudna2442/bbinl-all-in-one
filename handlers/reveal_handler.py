def register(bot, custom_command_handler, command_prefixes_list): 
    ...
    def show_help(message):
        ...
        help_text = (
            ...
            "<code>/spam</code> or <code>.spam</code> — spam text\n"
            "<code>/spmtxt ammount</code> or <code>.spmtxt ammount</code> — spam text or imprase ur gf using /spmtxt 1000 i love u 1\n"
